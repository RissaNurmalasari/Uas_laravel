...
Route::post('api/buku/update', [BukuApiController::class, 'update'])->withoutMiddleware(['web', 'auth']);
Route::post('api/buku/delete', [BukuApiController::class, 'destroy'])->withoutMiddleware(['web', 'auth']);
Route::post('/api/loginapi', [LoginController::class, 'loginAPI'])->withoutMiddleware(['web', 'auth']);
Route::get('/api/loginapi', [LoginController::class, 'loginAPI'])->withoutMiddleware(['web', 'auth']);
